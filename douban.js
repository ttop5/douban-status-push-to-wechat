...
const USERID = xxxxx;  // 豆瓣用户 id。目前只支持整数型 id, 字母型的 id，可以通过头像图片链接来找到其整数型 id，图片命名规则ul[uid]-*.jpg
const SCKEY = 'xxxxx';  // Server 酱申请的 SCKEY，申请地址：http://sc.ftqq.com/3.version
